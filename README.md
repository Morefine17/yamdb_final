# yamdb_final
![example workflow](https://github.com/Morefine17/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)
...
```
git clone https://github.com/Morefine17/yamdb_final
```
